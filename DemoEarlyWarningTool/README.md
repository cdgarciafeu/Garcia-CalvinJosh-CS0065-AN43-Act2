...
This repository contains the required output for Asynchronous Activity 2. The project uses KNIME to predict student risk status from academic performance data. 
